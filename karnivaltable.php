            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="signin.html" class="dropdown-item">Add Ticket Selling Information</a>
                            <a href="signup.html" class="dropdown-item">View Ticket Information</a>
                            <a href="404.html" class="dropdown-item"> Billing Information</a>
                ...
                <div class="row ">
                       ...
                       <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h2 class="mb-4">Info Table for Karnival</h2>
                            <table class='table'>
                            <thead>
                            <tr>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row["formed"] ?></td>
                                    <td><?php echo $row["genre"] ?></td>
                                    <td><?php echo $row["theme"] ?></td>
                                    <td><?php echo $row["yearactive"] ?></td>
                                    <td><?php echo $row["label"] ?></td>
                                    <td><?php echo $row["summary"] ?></td>
                                    
                                    <td><?php echo $row["discography"] ?></td>
                                    <td><?php echo $row["members"] ?></td>
                                    <td><a href='editkarnival.php?id=<?php echo $row["bid"] ?>'>Edit</a></td>
