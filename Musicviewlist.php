                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row["song_band"] ?></td>
                                    <td><?php echo $row["song_link"] ?></td>
                                     <td><?php echo $row["song_time"] ?></td>
                                    ...
                                    <td><a href='editMusicview.php?id=<?php echo $row["song_id"] ?>'>Edit</a> 
                                    | <a href='deleteSongslist.php?id=<?php echo $row["song_id"] ?>'>Delete</a>
