...
if(isset($_POST['submit'])){
    ...
    $sql4 = "INSERT INTO karnival (origin,  location, status, formed, genre, theme, yearactive, label, summary, discography, members)VALUES('$origin', '$location', '$status', '$formed', '$genre', '$theme', '$yearactive', '$label', '$summary', '$discography', '$members')";
            ...
            <div class="container-fluid">
                <div class="row ">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <h2 class="mb-4">Karnival Info</h2>
                            <?php
        if(isset($message)){
            ?>
