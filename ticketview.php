                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="button.html" class="dropdown-item">Add Information</a>
                            <a href="typography.html" class="dropdown-item">Update Information</a>
                            <a href="element.html" class="dropdown-item">Delete Information</a>
                        </div>
                    </div>
                      <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="element.html" class="dropdown-item">Cart-items</a>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="signin.html" class="dropdown-item">Add Information</a>
                            <a href="signup.html" class="dropdown-item">Update Information</a>
                            <a href="404.html" class="dropdown-item">Delete Information</a>
                           
                        </div>
                    </div>
                   
                     <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Add Album</a>
                        <div class="dropdown-menu bg-transparent border-0">
                           <a href="Musicview.php" class="dropdown-item">Add Album</a>
                            <a href="Musicviewlist.p" class="dropdown-item">View Album</a>
                ...
                <div class="row ">
                       ...
                       <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h2 class="mb-4">Ticket Selling Table</h2>
                            <table class='table'>
                            <thead>
                            <tr>
                                <th>Band Name</th>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row["ticket_venue"] ?></td>
                                    ...
                                    <td><a href='editTicketSelling.php?id=<?php echo $row["ticket_id"] ?>'>Edit</a> 
                                    | <a href='deleteTicketSelling.php?id=<?php echo $row["ticket_id"] ?>'>Delete</a>
                                    |<a href='trashProducts.php?id=<?php echo $row["product_id"] ?>'>Trash</a></td>
                                </tr>
