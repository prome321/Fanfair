...
if(isset($_POST['submit'])){
    ...
    $sql4 = "INSERT INTO artcell (origin,  location, status, formed, genre, theme, yearactive, label, summary, discography, members)VALUES('$origin', '$location', '$status', '$formed', '$genre', '$theme', '$yearactive', '$label', '$summary', '$discography', '$members')";
