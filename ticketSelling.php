...
if(isset($_POST['submit'])){
    $ticket_name = $_POST['ticketname'];
    $ticket_date = $_POST['ticketdate'];
    $ticket_venue = $_POST['ticketvenue'];
    $ticket_price=$_POST['ticketprice'];
  

    
        if(!isset($ticket_name) && !isset($ticket_date)&& !isset($ticket_venue) && !isset($ticket_price)){
            $message = "Please insert values";
        }
        else{
    $sql3 = "INSERT INTO ticket (ticket_name,ticket_date, ticket_venue,ticket_price)VALUES('$ticket_name', '$ticket_date', '$ticket_venue', '$ticket_price')";
            ...
            <div class="container-fluid">
                <div class="row ">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <h2 class="mb-4">Insert Ticket Information</h2>
                            <?php
        if(isset($message)){
            ?>
        ...
        ?>
                            <form method="post" enctype="multipart/form-data">
                                <div class="col-mb-12 py-4">
                                    <label   for="Ticketname" class="form-label">Band name</label>
                                    <input type="text" class="form-control" id="Ticketname" name="ticketname"  placeholder="Band Name">
                                    
                                </div>
                                <div class="col-mb-12">
                                    <label for="Ticketdate"  class="form-label">Date</label>
                                   
                                     <input type="text" class="form-control" id="Ticketdate" name="ticketdate"  placeholder="Date">
                                </div>
                               <div class="col-mb-12 py-4">
                                  <label for="Ticketvenue">Venue</label>
                             
                                     <input type="text" class="form-control" id="Ticketvenue" name="ticketvenue"  placeholder="Venue">
