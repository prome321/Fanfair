...
if(isset($_POST['submit'])){
    ...
    $song_link = $_POST['songlink'];
    $song_band = $_POST['songband'];
    $song_time=$_POST['songtime'];
  

    
        if(!isset($song_name) && !isset($song_link)&& !isset($song_band) && !isset($song_time)){
            $message = "Please insert values";
        }
        else{
    $sql3 = "INSERT INTO songs (song_name,song_link, song_band,song_time)VALUES('$song_name', '$song_link', '$song_band', '$song_time')";
            ...
            <div class="container-fluid">
                <div class="row ">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <h2 class="mb-4">Insert Music Information</h2>
                            <?php
        if(isset($message)){
            ?>
        ...
        ?>
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-mb-12 py-4">
                                    ...
                                    <input type="text" class="form-control" id="Songlink" name="songlink"  placeholder="Song Link">
                                    
                                </div>
                                
                               <div class="col-mb-12 py-4">
                                  <label for="Songband">Band Name</label>
                             
                                     <input type="text" class="form-control" id="Songband" name="songband"  placeholder="Band Name">


                              
                            </div>
                               <div class="col-mb-12 py-4">
                                  <label for="Songtime">Time</label>
                             
                                     <input type="text" class="form-control" id="Songtime" name="songtime"  placeholder="Time">
