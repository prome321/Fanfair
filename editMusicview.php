...
include('config.php');
  ...
  if(isset($_GET['id'])){
     $songID = $_GET['id'];
    $sql3 = "SELECT * FROM songs WHERE song_id = '$songID'";
 ...
 if(isset($_POST['Sub'])){
    ...
    $song_link = $_POST['song_link'];
     $song_band = $_POST['song_band'];
    $song_time = $_POST['song_time'];
     $sql3 = "UPDATE songs SET song_name='$song_name',song_link='$song_link',song_band='$song_band',song_time='$song_time' WHERE song_id='$songID'";
                ...
                <div class="row  pt-4 px-4">
                     ...
                     <div class="col-sm-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h2 class="mb-4">Edit Songs List</h2>
                            <form  method="post">
                                   <input type="hidden" value='<?php echo $song_id ?>' name='hiddenID'>
                                <div class="row mb-3 py-4">
                                  

                                    <label for="Songname" class="col-sm-2 col-form-label"> Band Name</label>
                                    <div class="col-sm-10">
                                         <input type="text" class="form-control" id="Songname" name='song_name' 
                                            value='<?php echo $row['song_name'];?>'> 
                                       
                                     
                                    </div>
                                     <label for="Songlink" class="col-sm-2 col-form-label">Song Link</label>
                                    <div class="col-sm-10">
                                         <input type="text" class="form-control" id="Songlink" name='song_link' 
                                            value='<?php echo $row['song_link'];?>'> 
                                       
                                       
                                    </div>
                                     <label for="Songband" class="col-sm-2 col-form-label">Band Name</label>
                                    <div class="col-sm-10">
                                         <input type="text" class="form-control" id="tickevenue" name='song_band' 
                                            value='<?php echo $row['song_band'];?>'> 
                                       
                                        
                                    </div>
                                     <label for="Songtime" class="col-sm-2 col-form-label">Time</label>
                                    <div class="col-sm-10">
                                         <input type="text" class="form-control" id="Songtime" name='song_time' 
                                            value='<?php echo $row['song_time'];?>'> 
