...
if(isset($_POST['submit'])){
    ...
    $members = $_POST['members']; 
         ...
         if(!isset($origin) && !isset($location)&& !isset($status) && !isset($formed) && !isset($genre) && !isset($theme)&& !isset($yearactive) && !isset($label) && !isset($summary) && !isset($appearance) && !isset($discography)&& !isset($members)){
            $message = "Please insert values";
        }
        else{
    $sql4 = "INSERT INTO warfaze (origin,  location, status, formed, genre, theme, yearactive, label, summary, appearance, discography, members)VALUES('$origin', '$location', '$status', '$formed', '$genre', '$theme', '$yearactive', '$label', '$summary', '$appearance', '$discography', '$members')";
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-mb-12">
                                    <label for="Summary"  class="form-label">Summary</label>
                                      ...
                                      <textarea class="form-control" placeholder="Summary"  name="summary" rows="6"></textarea>
                                </div>
                                <div class="col-mb-12">
                                    <label for="Appearance"  class="form-label">Compilation Appearances</label>
                                   
                                      <textarea class="form-control" placeholder="Compilation Appearances"  name="appearance" rows="10"></textarea>
                                </div>
