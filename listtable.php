                       ...
                       <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <tr>
                                ...
                                <th>List Date</th>
                                <th>List Text</th>
                                 <th>List Text Area</th>
                                  <th>List Image</th>
                            </tr>
                            </thead>
                            <tbody>
                                 <?php
                            $sql4 = "SELECT * FROM list";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row["listcategory"] ?></td>
                                    <td><?php echo $row['listdate'] ?></td>
                                    <td><?php echo $row['listtext'] ?></td>
                                       <td><?php echo $row['listtextarea'] ?></td>
                                   <td> <?php if(isset($row['listimage']) && !empty($row['listimage'])){
                  ?>
                                    <img src="<?php echo $row['listimage']; ?>" alt="" height='150' width='150'>
...
<?php
 ...
 ?>
                            ...
                            <?php
                                    ...
                                    <td><a href='editlisttable.php?id=<?php echo $row["list_id"] ?>'>Edit</a> 
                                    | <a href='deletelisttable.php?id=<?php echo $row["list_id"] ?>'>Delete</a>
