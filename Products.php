...
<body>
                ...
                <div class="row ">
                       ...
                       <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <tbody>
                                 <?php
                            $sql4 = "SELECT * FROM product WHERE delete_id='0'";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                <tr>
                                    ...
                                    <td> <?php if(isset($row['thumb']) && !empty($row['thumb'])){
                  ?>
                                    <img src="<?php echo $row['thumb']; ?>" alt="" height='150' width='150'>
 ...
 ?>
                            ...
                            <?php
                                    ...
                                    | <a href='deleteProducts.php?id=<?php echo $row["product_id"] ?>'>Delete</a>
