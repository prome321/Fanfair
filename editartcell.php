...
include('config.php');
  ...
  if(isset($_GET['id'])){
     $bid = $_GET['id'];
    $sql4 = "SELECT * FROM artcell where bid = '$bid'";
 ...
 if(isset($_POST['Sub'])){
    ...
    $members = $_POST['members']; 
     $sql3 = "UPDATE artcell SET origin='$origin',location='$location',status='$status',formed='$formed',genre='$genre',theme='$theme',yearactive='$yearactive',label='$label',summary='$summary', discography='$discography',members='$members' WHERE bid='$bid'";
 
    if ($conn->query($sql3) === TRUE) {
        echo "Record updated successfully";
        header('location:artcelltable.php');
      } else {
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                             <a href="Musicview.php" class="dropdown-item">Add Album</a>
                             <a href="Musicviewlist.php" class="dropdown-item">Add Album</a>
