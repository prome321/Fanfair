...
include('config.php');
  ...
  if(isset($_GET['id'])){
     $bid = $_GET['id'];
    $sql4 = "SELECT * FROM karnival where bid = '$bid'";
 ...
 if(isset($_POST['Sub'])){
    ...
    $members = $_POST['members']; 
     $sql3 = "UPDATE karnival SET origin='$origin',location='$location',status='$status',formed='$formed',genre='$genre',theme='$theme',yearactive='$yearactive',label='$label',summary='$summary', discography='$discography',members='$members' WHERE bid='$bid'";
 
    if ($conn->query($sql3) === TRUE) {
        echo "Record updated successfully";
        header('location:karnivaltable.php');
      } else {
