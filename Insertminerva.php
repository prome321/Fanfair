...
if(isset($_POST['submit'])){
    ...
    $sql4 = "INSERT INTO minerva (origin,  location, status, formed, genre, theme, yearactive, label, summary, appearance, discography, members)VALUES('$origin', '$location', '$status', '$formed', '$genre', '$theme', '$yearactive', '$label', '$summary', '$appearance', '$discography', '$members')";
